...
public class RequirementsController {
    ...
    @GetMapping("")
    public ResponseEntity<Object[]> getRemainingRequirements(@PathVariable("concentrationSelection") String concentrationSelection) {
        // Check that the concentrationSelection is valid.
        CourseController courseController = new CourseController();
        if (!courseController.validRequirementSatisfaction(concentrationSelection)) {
            return new ResponseEntity<>(null, HttpStatus.NOT_ACCEPTABLE);
        }

        // TODO Create an instance of the CourseRequirements class.
